...
class AbsencesControllerTest < ActionController::TestCase
  ...
  test "should create absence" do
    assert_difference('Absence.count') do
      post :create, absence: { comment: @absence.comment, end_day: @absence.end_day, reason: @absence.reason, start_day: @absence.start_day, user_id: @absence.user_id }
    end
  ...
  test "should update absence" do
    patch :update, id: @absence, absence: { comment: @absence.comment, end_day: @absence.end_day, reason: @absence.reason, start_day: @absence.start_day, user_id: @absence.user_id }
    assert_redirected_to absence_path(assigns(:absence))
  end
